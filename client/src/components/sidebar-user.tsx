...
export const SidebarUser = ({ user, isCollapsed }: SidebarUserProps) => {
  ...
  return (
    <div
      className={`flex h-full flex-col transition-all duration-300 ease-in-out ${isCollapsed ? "w-0 opacity-0" : "ml-2 w-64 overflow-hidden rounded-xl border bg-clip-padding opacity-100"}`}
    >
      <div
